...
export const CareerPage4 = (
  <div style={{ display: 'flex', height: '100%', overflow: 'hidden' }}>
    ...
    <L>
      ...
      <B style={{ fontSize: '10px', lineHeight: 1.5, marginBottom: '4px' }}>At Brand New Galaxy MEA I built customer trend analyses in Excel and ended up presenting them to the Nestle marketing team, work that drove an eight percent sales lift across the e-retailers we tracked.</B>
      <div style={{ flex: 1 }} />
