...
export const CareerPage1 = (
  <div style={{ display: 'flex', height: '100%', overflow: 'hidden' }}>
    <L>
      ...
      <B>The team was four when I joined and it's two now, and I've watched people leave while staying at the same intensity I started with. December was the hardest stretch. On Christmas Day, when everyone else took the day off, I ran the business solo and didn't break.</B>
...
export const CareerPage4 = (
  <div style={{ display: 'flex', height: '100%', overflow: 'hidden' }}>
    ...
    <R>
      ...
      <B style={{ fontSize: '10px', lineHeight: 1.5, marginBottom: '4px' }}>At seventeen I was at Zee Media analyzing how TV channels segment-approve programming, sitting in meetings where adults debated whether a show was "too serious for primetime." I took it more seriously than they did.</B>
      <B style={{ fontSize: '10px', lineHeight: 1.5, marginBottom: '4px' }}>A year earlier I'd been at Tata AMC at eighteen, the only researcher in the room who'd never traded a stock, tracking Indian firms' financial performance and the country's economic landscape for an investment audience.</B>
      <B style={{ fontSize: '10px', lineHeight: 1.5, marginBottom: '4px' }}>There was @thesolmag, where I produced lifestyle and culture content for an audience I was technically part of. And there was Innovations Group UAE, where I hosted corporate team-building events and learned that grown adults will follow you anywhere if you can keep a room laughing.</B>
